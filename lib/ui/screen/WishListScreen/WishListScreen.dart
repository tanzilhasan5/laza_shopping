    ...
    return Scaffold(
          ...
          trailing: CircleAvatar(
            ...
            child: InkWell(
              ...
              child: Padding(
                ...
                child: SvgPicture.asset('assets/icon/Bag.svg', color: Colors.black),
              ),
            ),
          ),
        ),
      ...
      body: Padding(
        ...
        child: Obx(() {
          ...
          final wishlistIds = wishlistItems.map((e) => e['id'].toString()).toSet();
          final wishlistedProducts = productController.productList
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Available in stock',
                        style: TextStyle(color: AppColor.textColor, fontSize: 13.sp),
                      ),
                    ],
                  ),
                  TextButton(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.sort_outlined, color: Colors.black, size: 18.sp),
                        SizedBox(width: 4.w),
                        Text(
                          'Sort',
                          style: TextStyle(
